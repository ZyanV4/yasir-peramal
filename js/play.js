...
function changeNumber(currentCards)
{
	...
	if (currentCards < 6) {
		...
		nString = '<a href="https://wa.me/+62895630128912?text=Anjay🗿" class="logo-ydv"></a><h4 class="pikir">Nomor Anda adalah <span>'+result+'</span> kan?🗿</h4>\
		<p class="pop">Jika nomornya tidak benar, Anda mungkin menjawab pertanyaan yang salah😁</p>\
		<a href="index.html" class="btn py-3 px-4 m-1 text-decoration-none">Main Lagi</a>';
